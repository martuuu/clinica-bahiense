...
export default async function AdministrativoPage({ 
  ...
  const { companyId, areaId, deviceId, insuranceId, modalityId } = await params;
  
  // Obtener modalidad
  const modality = await prisma.internmentModality.findUnique({
    where: { id: modalityId },
    include: {
      agreement: {
        include: {
  ...
  const breadcrumbs = [
    ...
    { label: modality.name, href: `/${companyId}/${areaId}/${deviceId}/${insuranceId}/${modalityId}` },
    { label: 'Administrativo', href: `/${companyId}/${areaId}/${deviceId}/${insuranceId}/${modalityId}/administrativo` },
  ];
    ...
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Facturación, honorarios y convenios</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Modalidad</h3>
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{modality.code}</span>
              </div>
            </div>
          </Card>
